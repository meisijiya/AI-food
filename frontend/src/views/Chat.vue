    ...
    <div class="input-area">
      <div class="input-wrapper">
        ...
        <input
          ...
          class="chat-input"
        />
        <button class="send-btn btn-primary-gradient btn-breath" :disabled="!inputValue.trim() || !chatStore.isConnected" @click="sendMessage">
...
/* Messages: now using MessageBubble component (cleanup Phase 4 P0) */

/* Thinking indicator */
.thinking-indicator {
  display: flex; align-items: center; gap: var(--space-2); align-self: flex-start;
